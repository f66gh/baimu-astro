...
export const ui = {
	zh: {
		...
		homeLogbookDescription: '记录我每天都干了什么，用于训练我的专注力和记忆力。',
		...
		logbookListLede: '用列表模式快速回看每天的行动、切换和注意力痕迹。',
		openNav: '打开导航',
		closeNav: '关闭导航',
		siteNav: '站点导航',
		breadcrumbNav: '页面层级',
	...
	en: {
		...
		homeLogbookDescription: 'Recording what I did every day to train my focus and memory.',
		...
		logbookListLede: 'A compact list for reviewing daily actions, context switches, and attention traces.',
