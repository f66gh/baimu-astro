...
export const ui = {
	zh: {
		...
		about: '关于我',
		homeAcademicDescription: '展示已经形成独立项目的学术成果，目前集中记录 X-Cap。',
		homeNotesDescription: '统一放置论文阅读、组内任务、学习记录、工具笔记和自由探索。',
		homeLogbookDescription: '定期复盘自己学到了什么，哪里做的好哪里做的不好。',
		homeMusicDescription: '每次听到喜欢的曲子，都会忍不住幻想自己也能把它弹出来。',
		academicEyebrow: 'Academic',
		notesEyebrow: 'Notes',
		logbookEyebrow: 'Logbook',
		academicListLede: '用更紧凑的列表回看已经形成独立项目的学术成果。',
		notesListLede: '用列表模式快速扫描论文阅读、组内任务、工具记录和学习材料。',
		logbookListLede: '定期复盘自己学到了什么，哪里做的好哪里做的不好。',
		openNav: '打开导航',
		closeNav: '关闭导航',
		siteNav: '站点导航',
		breadcrumbNav: '页面层级',
	...
	en: {
		...
		siteShortName: 'Aiu Web',
		about: 'About',
		homeAcademicDescription: 'Research projects that have grown into standalone academic output, currently centered on X-Cap.',
		homeNotesDescription: 'Paper reading, group tasks, learning notes, tool records, and open-ended explorations.',
		homeLogbookDescription: 'Regularly reflecting on what I have learned, what I did well, and what I did not do well.',
		homeMusicDescription: 'Every favorite piece makes me imagine that one day I might play it well myself.',
		academicEyebrow: 'Academic',
		notesEyebrow: 'Notes',
		logbookEyebrow: 'Logbook',
		academicListLede: 'A compact list of research projects that have grown into standalone academic output.',
		notesListLede: 'A compact list for scanning paper reading, group tasks, learning notes, and tool records.',
		logbookListLede: 'Regularly reflecting on what I have learned, what I did well, and what I did not do well.',
		...
		backToAcademic: 'Go to Research Output',
		backToNotes: 'Go to Notes',
		backToLogbook: 'Go to Logbook',
		animeEyebrow: 'Anime',
